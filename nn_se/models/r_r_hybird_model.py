...
class RR_HYBIRD_MODEL(Module):
  ...
  def get_loss(self, forward_outputs):
    ...
    self.comp_net_reMagMse = losses.batch_real_relativeMSE(p_est_clean_mag_batch, self.clean_mag_batch, PARAM.relative_loss_AFD)
    ...
    self.comp_net_reSpecMse = losses.batch_complex_relativeMSE(p_est_clean_spec_batch, cliped_clean_spec_batch, PARAM.relative_loss_AFD)
    ...
    self.comp_net_reWavL2 = losses.batch_wav_relativeMSE(p_est_clean_wav_batch, self.clean_wav_batch, PARAM.relative_loss_AFD)
