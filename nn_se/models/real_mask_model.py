...
class CNN_RNN_REAL_MASK_MODEL(Module):
  ...
  def get_loss(self, forward_outputs):
    ...
    ## time domain loss
    self.real_net_clean_wav_L1_loss = losses.batch_wav_L1_loss(est_clean_wav_batch, self.clean_wav_batch)
    self.real_net_clean_wav_L2_loss = losses.batch_wav_L2_loss(est_clean_wav_batch, self.clean_wav_batch)
    # engregion losses
    ...
    for name in loss_names:
      loss += {
        ...
        'real_net_clean_wav_L1_loss': self.real_net_clean_wav_L1_loss,
        'real_net_clean_wav_L2_loss': self.real_net_clean_wav_L2_loss,
      }[name]
    return loss
